...
![](./images.assets/20201124211311.png)
...
![](./images.assets/20201124212858.png)

![](./images.assets/20201124212847.png)

![](./images.assets/20201124212841.png)
...
![](./images.assets/20201124220501.png)
...
![](./images.assets/20240905110146.png)
...
历史版本下载：https://www.elastic.co/cn/downloads/past-releases#kibana

#### 2、安装

解压即可（尽量将ElasticSearch相关工具放在统一目录下）

![](./images.assets/20201124224049.png)

#### 3、启动

![](./images.assets/20201124224155.png)
...
![](./images.assets/20201124225557.png)
...
![](./images.assets/20201125003531.png)
...
![](./images.assets/20201125005908.png)

### 3、重启ElasticSearch

### 4、使用 `ElasticSearch安装补录/bin/elasticsearch-plugin` 可以查看插件

![](./images.assets/20201201144846.png)

### 5、使用kibana测试

`ik_smart`：最少切分

![](./images.assets/20201125013948.png)

`ik_max_word`：最细粒度划分（穷尽词库的可能）

![](./images.assets/20201125014210.png)

从上面看，感觉分词都比较正常，但是大多数，分词都满足不了我们的想法，如下例

![](./images.assets/20201125015809.png)
...
![](./images.assets/20201125020519.png)

创建字典文件，添加字典内容

![](./images.assets/20201125020802.png)

重启ElasticSearch，再次使用kibana测试

![](./images.assets/20201125021137.png)
...
![](./images.assets/20201201144937.png)

![](./images.assets/20201201144942.png)
...
![](./images.assets/20201201144947.png)
...
![](./images.assets/20201201144955.png)
...
![](./images.assets/20201201145002.png)
...
![](./images.assets/20201201145010.png)

![](./images.assets/20201201160911.png)
...
![](./images.assets/20240906102224.png)

##### ①查询匹配

- `match`：匹配（会使用分词器解析（先分析文档，然后进行查询））
- `_source`：过滤字段(一个索引里面有很多字段，如果不指定，查询会把所有字段都查找出来)
- `sort`：排序
- `form`、`size` 分页

![](./images.assets/20240906102842.png)

![](./images.assets/20240906103023.png)

![](./images.assets/20240906104856.png)

![](./images.assets/20240906105022.png)

![](./images.assets/20201203002017.png)
...
![](./images.assets/20201203150635.png)
...
![](./images.assets/20201203150641.png)
...
![](./images.assets/20201203150652.png)
